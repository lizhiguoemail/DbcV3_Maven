...
public class Dbc_LucenePage<T> {
	/**当前第几页(从1开始计算)*/
	  ...
	  public Dbc_LucenePage() {}
	  public Dbc_LucenePage(int currentPage, int pageSize) {
	    this.currentPage = currentPage;
	    this.pageSize = pageSize;
	  }
	  public Dbc_LucenePage(int currentPage, int pageSize, Collection<T> items) {
	    this.currentPage = currentPage;
	    this.pageSize = pageSize;
	    this.items = items;
	  }
	  public Dbc_LucenePage(int currentPage, int pageSize, Collection<T> items, int groupSize) {
	    this.currentPage = currentPage;
	    this.pageSize = pageSize;
	    this.items = items;
	    this.groupSize = groupSize;
	  }
	  public Dbc_LucenePage(int currentPage, int pageSize, int groupSize, int afterDocId) {
	    this.currentPage = currentPage;
	    this.pageSize = pageSize;
	    this.groupSize = groupSize;
	    this.afterDocId = afterDocId;
	  ...
	  public static void main(String[] args) {
	    ...
	    Dbc_LucenePage<Integer> page = new Dbc_LucenePage<Integer>(1,10,items,10);
