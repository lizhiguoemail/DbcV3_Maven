...
public class Dbc_systeminfo {
	...
	public static Dbc_systeminfo SYSTEMINFO;
	
	public static Dbc_systeminfo getInstance(){
		if(SYSTEMINFO == null){
			SYSTEMINFO = new Dbc_systeminfo();
		}
		return SYSTEMINFO;
	}
	
	
	public static Dbc_systeminfo getInstance(HttpServletRequest request){
		if(SYSTEMINFO == null){
			SYSTEMINFO = new Dbc_systeminfo(request);
		}
		else {
	...
	private Dbc_systeminfo() {
		super();
		init();
	}
	
	private Dbc_systeminfo(HttpServletRequest request) {
		super();
		init();
		/**
		 * 额外信息
	...
	private void ipMac() throws Exception{
		...
		Dbc_systeminfo.this.os_ip = sIP;
		Dbc_systeminfo.this.os_mac = sMAC;
	}
	...
	public static void main(String[] args) {
		Dbc_systeminfo sf=new Dbc_systeminfo();
		sf.PrintInfo();
