...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top" background="<%=path %>/images/backstage/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
  ...
  <tr>
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2" valign="top"><span class="left_bt">感谢您使用 <c:if test="${not empty webconfig}">${webconfig.webtitle}</c:if>
    	<c:if test="${ empty webconfig}">DBC</c:if>-后台管理系统</span></td>
        <td width="7%">&nbsp;</td>
        <td width="40%" valign="top"><table width="100%" height="144" border="0" cellpadding="0" cellspacing="0" class="line_table">
          <tr>
            <td width="7%" height="27" background="<%=path %>/images/backstage/news-title-bg.gif"><img src="<%=path %>/images/backstage/news-title-bg.gif" width="2" height="27"></td>
            <td width="93%" background="<%=path %>/images/backstage/news-title-bg.gif" class="left_bt2">最新动态</td>
          </tr>
          <tr>
      ...
      <tr>
        <td width="2%">&nbsp;</td>
        <td width="51%" class="left_txt"><img src="<%=path %>/images/backstage/icon-mail2.gif" width="16" height="11"/> 联系方式：390989627@qq.com<br/>
              <img src="<%=path %>/images/backstage/icon-phone.gif" width="17" height="14"/> 官方网站：${webconfig.weburl }</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
