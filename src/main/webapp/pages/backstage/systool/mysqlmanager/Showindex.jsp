  ...
  function setdelete(){
   ...
   function deleteone(id){
    ...
    <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
      <tr>
        <th width="40px">序号</th>
        <th width="120px;">索引名</th>
        <th width="120px;">索引类型</th>
        <th width="120px;">对应列</th>
      </tr>
      <c:forEach items="${indexs}" var="index" varStatus="v">
      <tr class="hovertr">
