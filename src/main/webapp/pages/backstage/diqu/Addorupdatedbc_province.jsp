...
<body style="min-height:500px;">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <form action="<%=path %>/dbc_province.action?methode=addorupdate" method="post" name="form1">
    <input type="hidden" name="id" value="${dbc_province.id }" />
    <input type="hidden" name="createdate" value="${dbc_province.createdate }" />
    <input type="hidden" name="createuser" value="${dbc_province.createuser }" />
    <input type="hidden" name="isupdate" value="${isupdate }" />
    <table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
      <tr>
        <td width="115px" align="right">省份名称：</td>
        <td>&nbsp;<input name="provincename" type="text" id="provincename" value="${dbc_province.provincename }" /></td>
      </tr>
      <tr>
        <td align="right">排序：</td>
        <td>&nbsp;<input name="sortcode" type="text" id="sortcode" value="${dbc_province.sortcode }"  onkeyup="value=value.replace(/[^\d\.]/g,'')"/> 数字越小越靠前</td>
      </tr>
      <tr>
        <td align="right">&nbsp;</td>
