...
<link rel="stylesheet" type="text/css" href="<%=path %>/css/backstage/skin.css" />
  <script type="text/javascript">
    function tj(){
    	if(confirm('确认要初始化数据吗？初始化后，省份、城市、地区的数据都将恢复为系统自带默认数据')){
...
<jsp:include page="../../common/doing.jsp" />
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <form action="<%=path %>/dbc_province.action?methode=add_province_city_district" method="post" name="form1">
    <table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
      <tr>
        <td>&nbsp;<input type="button" value="地区数据初始化" onclick="tj()"/></td>
      </tr>
    </table>
    </form></td>
